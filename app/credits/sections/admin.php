 <div class='row mt-2 mb-2'>
     <div class='col-md-3'>
         <div class='shadow-sm bg-success p-3 b-r-2'>
             <h1 class='bold b mb-0'><?php echo $TotalCredits = AMOUNT("SELECT * FROM credits", "credits_numbers"); ?></h1>
     ...
     <div class='col-md-3'>
         <div class='shadow-sm bg-info p-3 b-r-2'>
             <h1 class='bold b mb-0'>
                 <?php
                    echo $UsedCredits = AMOUNT("SELECT * FROM campaigns", "campaign_deductions");
                    ?>
             </h1>
             <p>Used Credits</p>
         </div>
     ...
     <div class='col-md-3'>
         <div class='shadow-sm bg-danger p-3 b-r-2'>
             <h1 class='bold b mb-0'><?php echo $UsedCredits = AMOUNT("SELECT * FROM credits where credit_status='EXPIRED'", "credits_numbers"); ?></h1>
             <p>Expired Credits</p>
         </div>
     </div>
 </div>
 ...
 <div class='row mt-2'>
     <div class="col-md-9">
         ...
         <?php
            $AllCredits = SET_SQL("SELECT * FROM credits ORDER BY credit_ids  DESC", true);
            if ($AllCredits != null) {
         ...
         <div class='row'>
             <?php
                if (isset($_GET['creditid'])) {
                    ...
                    $CreditSQL = "SELECT * FROM credits where credit_ids='" . $CreditId . "'";
