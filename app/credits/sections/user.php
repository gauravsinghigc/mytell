 <div class='row mt-2 mb-2'>
     <div class='col-md-3'>
         <div class='shadow-sm bg-success p-3 b-r-2'>
             <h1 class='bold b mb-0'><?php echo $TotalCredits = AMOUNT("SELECT * FROM credits where credit_main_user_id='" . LOGIN_UserId . "'", "credits_numbers"); ?></h1>
             <p>Total Credit Transferred</p>
         </div>
     </div>
     <div class='col-md-3'>
         <div class='shadow-sm bg-info p-3 b-r-2'>
             <h1 class='bold b mb-0'>
                 <?php
                    echo $UsedCredits = AMOUNT("SELECT * FROM campaigns where campaign_main_user_id='" . LOGIN_UserId . "'", "campaign_deductions");
                    ?>
             </h1>
             <p>Used Credits</p>
         </div>
     ...
     <div class='col-md-3'>
         <div class='shadow-sm bg-dark p-3 b-r-2'>
             <h1 class='bold b mb-0'><?php echo $UnUsedCredits = $TotalCredits - $UsedCredits; ?></h1>
             <p>Un Used Credits</p>
         </div>
     </div>
     <div class='col-md-3'>
         <div class='shadow-sm bg-danger p-3 b-r-2'>
             <h1 class='bold b mb-0'><?php echo $UsedCredits = AMOUNT("SELECT * FROM credits where  credit_main_user_id='" . LOGIN_UserId . "' and credit_status='EXPIRED'", "credits_numbers"); ?></h1>
             <p>Expired Credits</p>
         </div>
     </div>
 </div>
 ...
 <div class='row mt-2'>
     <div class="col-md-9">
         ...
         <?php
            $AllCredits = SET_SQL("SELECT * FROM credits where credit_main_user_id='" . LOGIN_UserId . "' ORDER BY credit_ids  DESC", true);
            if ($AllCredits != null) {
            ...
            ?>
                 <div class="data-list flex-s-b lh-1-1">
                     ...
                     <span class='w-pr-15 text-success bold'>
                     ...
                     <span class='w-pr-15 pt-1'>
                         <?php echo CreditStatus($Credits->credit_status); ?>
                     </span>
                     <span class='w-pr-15 text-right pt-1'>
         ...
         <div class='row'>
             <?php
                if (isset($_GET['creditid'])) {
                    ...
                    $CreditSQL = "SELECT * FROM credits where  credit_main_user_id='" . LOGIN_UserId . "' and credit_ids='" . $CreditId . "'";
